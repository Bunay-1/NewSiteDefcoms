...
export default function AiChatbot() {
  ...
  const quickPrompts = [
    ...
    { text: "Какво е DORA регулацията?", label: "DORA изисквания" },
    { text: "Колко струва защитата?", label: "Ценообразуване" },
    { text: "Как да се защитя от Ransomware?", label: "Защита от Ransomware" }
  ];
  ...
  const keywordAnswers: { keywords: string[]; answer: string }[] = [
    ...
    },
    {
      ...
      answer: "Регламентът DORA (Digital Operational Resilience Act) се отнася до всички финансови субекти в ЕС (банки, застрахователи, инвестиционни посредници, финтех фирми) и техните ИТ партньори. Изисква строг контрол на рисковете, тестване за проникване (Pentesting) и мониторинг на доставчиците. DefComs предлагает цялостни услуги за DORA съответствие."
    },
    {
      keywords: ["цена", "цени", "колко струва", "абонамент", "евро"],
      answer: "Всички наши лицензи и услуги са прецизирани в Евро (€). Базовият ни пакет за Endpoint защита започва от 200 €/месец, а цялостното SIEM решение и денонощен SOC мониторинг започват от 1200 €/месец. Можете да сглобите точния си пакет в нашия интерактивен Конфигуратор на адрес: /tools/bundle !"
    },
    {
