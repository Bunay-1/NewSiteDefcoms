  ...
  const scenarios: PhishingScenario[] = [
    {
      ...
      body: (
        <div className="space-y-3 font-sans text-sm text-slate-800">
          ...
          <p>
            При автоматична проверка на Вашето досие за изминалата финансова година бяха установени несъответствия на стойност <span className="font-bold text-red-600">345.20 €</span>.
          </p>
          <p>
